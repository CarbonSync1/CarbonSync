    ...
    <div className="min-h-screen bg-[#fcfcfc] selection:bg-green-100 text-[#1a1a1a] scroll-smooth">
      ...
      <header className="pt-32 pb-24 px-6 text-center relative z-10">
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 border border-green-100 text-green-700 text-[10px] font-bold uppercase tracking-widest mb-8"
        >
          <Scale size={12} />
