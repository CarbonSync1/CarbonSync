    ...
    <div className="min-h-screen bg-[#fcfdfc] text-[#1a1a1a] scroll-smooth selection:bg-green-100">
      ...
      <header className="pt-64 pb-32 px-10 text-center relative z-10">
        <motion.div 
          ...
          className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white border border-green-100 text-green-700 text-[10px] font-black uppercase tracking-[0.3em] mb-12 shadow-sm"
        >
        ...
        <motion.h1 
          ...
          className="text-7xl md:text-9xl font-black tracking-tighter text-gray-900 mb-12 leading-[0.9]"
        >
        ...
        <motion.p 
          ...
          className="text-2xl text-gray-700 max-w-4xl mx-auto font-bold leading-relaxed"
        >
            ...
            <div className="space-y-10">
              ...
              <div className="p-10 rounded-[3rem] bg-gray-900 text-white shadow-2xl group/help">
                ...
                <div className="w-full h-1 bg-white/20 rounded-full overflow-hidden">
                  <motion.div className="h-full bg-white" animate={{ width: ['0%', '100%'] }} transition={{ duration: 3, repeat: Infinity }} />
                </div>
              </div>
            </div>
          </aside>
          ...
          <div className="col-span-12 lg:col-span-9">
            ...
            <Section id="mission" title="Our Privacy Sovereignty" index={0}>
              <p className="text-xl text-gray-800 leading-relaxed font-black mb-8">
                Privacy is not a feature; it is our foundation. CarbonSync operates on a "Zero-Trust" data model where we act as a secure vault for your ESG metrics.
              </p>
                  ...
                  <div className="space-y-10">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-gray-400 font-medium">pushkarsingh.carbonsync@gmail.com</p>
