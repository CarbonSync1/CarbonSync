...
function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <motion.div className="absolute inset-[-15%] z-0 will-change-transform" style={{ y: heroBgY }}>
        <img src="/hero_forest.png" alt="" className="w-full h-full object-cover" style={{ filter: 'hue-rotate(45deg) saturate(1.2)' }} />
        <div className="absolute inset-0 bg-gradient-to-b from-forest-deep/70 via-forest-deep/50 to-forest-deep/80" />
      </motion.div>

      <motion.div className="relative z-10 text-center max-w-[900px] px-[5%]" style={{ opacity: heroOpacity }}>
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }}>
          ...
          <motion.div
            ...
            className="inline-block bg-gradient-to-r from-eco-green to-eco-hover text-white px-6 py-2 rounded-lg font-heading font-extrabold tracking-wide mb-4 shadow-lg shadow-eco-green/40"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((b, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              whileHover={{ y: -6, boxShadow: '0 20px 40px rgba(76, 175, 80, 0.15)' }}
            >
                ...
                <svg viewBox="0 0 600 180" className="w-full h-[180px] overflow-visible">
                  ...
                  {[
                    ...
                    <g key={i} className="group">
                      ...
                      <motion.circle cx={d.x} cy={d.y} r="4.5" fill="#fff" stroke="#4caf50" strokeWidth="2.5"
                        initial={{ r: 0 }} whileInView={{ r: 4.5 }}
                        viewport={{ once: true }} transition={{ delay: 1.5 + i * 0.1 }}
  ...
  return (
    <section className="bg-beige-soft py-[60px] px-[5%]">
      <div className="max-w-[900px] mx-auto">
        ...
        <motion.div
          className="bg-white rounded-2xl p-8 max-md:p-6 text-center shadow-lg shadow-forest-mid/5 mb-8 relative"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        >
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  ...
                  <motion.div
                    ...
                    className="flex-shrink-0 w-8 h-8 rounded-full bg-eco-green/10 flex items-center justify-center"
                  >
