    ...
    <main className="min-h-screen overflow-hidden bg-slate-50 text-slate-600 relative pb-20 selection:bg-emerald-500/20 selection:text-emerald-900">
      ...
      <section className="relative px-6 py-20 md:px-12 lg:px-20 lg:py-28 max-w-7xl mx-auto">
        ...
        <div className="relative grid gap-16 lg:grid-cols-[1.1fr_0.9fr] items-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96, y: 15 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="relative plus-corner plus-top-left plus-top-right plus-bottom-left plus-bottom-right">
      ...
      <section id="mission" className="px-6 py-20 md:px-12 lg:px-20 max-w-7xl mx-auto">
        <div className="flex flex-col gap-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="w-full relative rounded-3xl overflow-hidden border border-slate-200 shadow-xl bg-white">
