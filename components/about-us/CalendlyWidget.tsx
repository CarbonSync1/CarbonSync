        ...
        <div className="event-card" style={{
          ...
          <div className="meta" style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <p style={{ margin: "6px 0", color: "#374151", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ fontSize: "18px" }}>⏱</span> 30 min
            </p>
            <p style={{ margin: "6px 0", color: "#374151", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ fontSize: "18px" }}>💻</span> Web conferencing details provided upon confirmation.
            </p>
            <p style={{ margin: "6px 0", color: "#374151", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ fontSize: "18px" }}>📅</span> 10:30am - 11:00am, Tuesday, May 5, 2026
            </p>
            <p style={{ margin: "6px 0", color: "#374151", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ fontSize: "18px" }}>🌍</span> India Standard Time
            </p>
          </div>
