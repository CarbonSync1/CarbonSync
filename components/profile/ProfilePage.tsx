          ...
          <nav className="space-y-1.5">
            {tabs.map((tab) => (
              ...
              >
                ...
                {activeTab === tab.id && (
                  <motion.div layoutId="activeTabIndicator" className="absolute right-4 w-1.5 h-1.5 bg-primary rounded-full shadow-[0_0_8px_rgba(20,184,166,0.6)]" />
                )}
              </button>
            ))}
          </nav>
            ...
            <div className="flex flex-col xl:flex-row items-center gap-12 relative z-10 w-full">
              ...
              <div className="flex-1 space-y-10 w-full text-center xl:text-left">
                ...
                <div className="flex flex-wrap justify-center xl:justify-start gap-4">
                  ...
                  <motion.button onClick={() => setModals({...modals, edit: true})} className="btn-secondary">
