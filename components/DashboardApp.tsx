          ...
          <main className="relative z-10 pt-60 pb-32 px-12 2xl:pl-56 max-w-[1800px] mx-auto">
            <div className="mb-24">
              <motion.p
                ...
                key={activeTab + 'p'}
                className="text-[14px] font-black text-emerald-400 uppercase tracking-[1.2em] mb-6"
              >
              ...
              <motion.h2
                ...
                animate={{ opacity: 1, y: 0 }}
                key={activeTab + 'h2'}
                className="text-8xl font-black tracking-tighter leading-none text-iridescent italic"
              >
