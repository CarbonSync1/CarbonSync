...
const allResources: Resource[] = [
  ...
  { type: 'Guide', title: 'CarbonSync Net Zero Planning Guide', desc: 'A practical step-by-step guide to help teams measure emissions, set targets, and move from planning to action with CarbonSync.', icon: BookOpen, tag: 'Net Zero', read: '8 min read', accent: 'accent-emerald', image: '/resources-assets/img5.webp' },
  { type: 'Guide', title: 'Advanced Scope 3 Emissions Modeling', desc: 'Deep dive into supply chain emissions modeling and data collection strategies with CarbonSync.', icon: BookOpen, tag: 'Net Zero', read: '12 min read', accent: 'accent-emerald', image: '/resources-assets/img10.webp' },
  { type: 'Guide', title: 'CarbonSync Decarbonization Guide', desc: 'Learn how to implement decarbonization strategies across your supply chain effectively.', icon: BookOpen, tag: 'Net Zero', read: '15 min read', accent: 'accent-emerald', image: '/resources-assets/img16.webp' },
  ...
  { type: 'Whitepaper', title: 'The Future of ESG Reporting with CarbonSync', desc: 'An analysis of upcoming regulatory changes and how companies can prepare their data infrastructure.', icon: FileText, tag: 'Carbon Data', read: 'Download PDF', accent: 'accent-lime', image: '/resources-assets/img11.webp' },
