...
function Timeline({ items }: { items: { year: string; title: string; desc: string }[] }) {
  return (
    <div className="detail-timeline">
      {items.map((t, i) => (
        <motion.div key={t.year} className="tl-item"
...
function CTAs({ onDownload }: { onDownload?: () => void }) {
  ...
  if (submitted) {
    return (
      <div className="detail-cta-success">
        ...
        <motion.button className="cta-ghost" whileHover={{ scale: 1.02 }} onClick={() => setSubmitted(null)}>
  ...
  return (
    <div className="detail-cta-row">
      <motion.button className="cta-primary" whileHover={{ scale: 1.02 }} onClick={onDownload}>
        <Download size={18} /> Download Whitepaper
      </motion.button>
      <motion.button className="cta-secondary" whileHover={{ scale: 1.02 }} onClick={() => setSubmitted('assessment')}>
        <BarChart3 size={18} /> Book Carbon Assessment
      </motion.button>
      <motion.button className="cta-accent" whileHover={{ scale: 1.02 }} onClick={() => setSubmitted('expert')}>
...
const heroImages: Record<string, string> = {
  'The Growing Importance of Biodiversity Metrics': '/img4.webp',
  'Navigating the SEC Climate Disclosure Rules': '/img5.webp',
  'Green IT: Reducing the Carbon Footprint of Your Software': '/img6.webp',
  'Decarbonizing Logistics and Last-Mile Delivery': '/img7.webp',
  'The Future of Renewable Energy Certificates (RECs)': '/img8.webp',
  'Overcoming Data Silos in ESG Reporting': '/img9.webp',
  'Understanding the Role of the VCMI in Carbon Markets': '/img12.webp',
  'Building Climate Resilience in Commercial Real Estate': '/img13.webp',
  'The Financial Risks of Ignoring Scope 3 Emissions': '/img14.webp',
  'How to Engage Your Board of Directors on ESG Goals': '/img15.webp',
  'Decoding the Latest IPCC Climate Change Report': '/img16.webp',
  'Sustainable Packaging: Beyond the Basics': '/img17.webp',
};
...
export const sectionImages: Record<string, Record<string, string>> = {
  ...
  'Decarbonizing Logistics and Last-Mile Delivery': {
    'overview': '/img7.webp',
    'route-optimization': '/img2.webp',
    'ev-adoption': '/img1.webp',
    'efficiency-dashboard': '/img3.webp',
    'carbon-calculator': '/img10.webp',
    'case-study': '/img5.webp',
  },
  'The Future of Renewable Energy Certificates (RECs)': {
    'overview': '/img8.webp',
    'market-trends': '/img2.webp',
    'market-valuation': '/img11.webp',
    'cert-lifecycle': '/img3.webp',
    'demand-analysis': '/img5.webp',
    'investment-growth': '/img1.webp',
  },
  'Overcoming Data Silos in ESG Reporting': {
    'overview': '/img9.webp',
    'architecture': '/img2.webp',
    'data-accuracy': '/img5.webp',
    'workflow': '/img3.webp',
    'case-study': '/img1.webp',
  },
  'Understanding the Role of the VCMI in Carbon Markets': {
    'overview': '/img12.webp',
    'pricing-trends': '/img11.webp',
    'market-growth': '/img5.webp',
    'verification-flow': '/img3.webp',
    'market-comparison': '/img2.webp',
  },
  'Building Climate Resilience in Commercial Real Estate': {
    'overview': '/img13.webp',
    'risk-heatmap': '/img4.webp',
    'performance': '/img5.webp',
    'cost-benefit': '/img11.webp',
    'risk-zoning': '/img3.webp',
  },
  'The Financial Risks of Ignoring Scope 3 Emissions': {
    'overview': '/img14.webp',
    'risk-exposure': '/img10.webp',
    'financial-loss': '/img5.webp',
    'investor-pressure': '/img1.webp',
    'roi-impact': '/img2.webp',
    'penalties': '/img3.webp',
  },
  ...
  'Greenwashing vs True Sustainability': {
    'overview': '/img15.webp',
    'red-flags': '/img11.webp',
    'transparency': '/img5.webp',
    'trust': '/img2.webp',
    'best-practices': '/img3.webp',
  },
  'The Role of AI in ESG Compliance': {
    'overview': '/img5.webp',
    'ai-applications': '/img13.webp',
    'automation': '/img4.webp',
    'predictive': '/img11.webp',
    'case-study': '/img2.webp',
  },
  'The Impact of Scope 3 Emissions on Global Supply Chains': {
    'overview': '/img3.webp',
    'breakdown': '/img10.webp',
    'supplier-engagement': '/img2.webp',
    'reduction': '/img5.webp',
    'strategy': '/img1.webp',
  },
  'Why Carbon Taxes Are Reshaping the Global Economy': {
    'overview': '/img5.webp',
    'global-rates': '/img11.webp',
    'impact': '/img2.webp',
    'business-response': '/img4.webp',
    'outlook': '/img3.webp',
  },
  ...
  'What is Decarbonization: Action Plan': {
    'overview': '/img10.webp',
    'roadmap': '/img1.webp',
    'milestones': '/img2.webp',
    'sectors': '/img4.webp',
    'action-plan': '/img5.webp',
  },
  'How to Build a Sustainable Procurement Strategy': {
    'overview': '/img2.webp',
    'criteria': '/img4.webp',
    'supplier-scoring': '/img5.webp',
    'integration': '/img3.webp',
    'case-study': '/img1.webp',
  },
  'Understanding the CBAM Regulation': {
    ...
    'mechanism': '/img3.webp',
    'impact': '/img11.webp',
    'compliance': '/img5.webp',
    'preparation': '/img2.webp',
  },
  'Best Practices for Energy Audits': {
    'overview': '/img15.webp',
    'audit-types': '/img3.webp',
    'methodology': '/img5.webp',
    'savings': '/img11.webp',
    'case-study': '/img2.webp',
  },
  ...
  'The Rise of Circular Economy Business Models': {
    'overview': '/img1.webp',
    'principles': '/img4.webp',
    'value-chains': '/img5.webp',
    'metrics': '/img2.webp',
    'case-study': '/img3.webp',
  },
  'Understanding the EU Corporate Sustainability Reporting Directive (CSRD)': {
    'overview': '/img2.webp',
    'requirements': '/img5.webp',
    'timeline': '/img3.webp',
    'readiness': '/img4.webp',
    'case-study': '/img1.webp',
  },
...
function HeroSection({ title }: { title: string }) {
  const img = heroImages[title] || '/img5.webp';
